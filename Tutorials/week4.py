...
#                      T   A   C   G
# ---------------------------------------------------------------------------
# We need to use maketrans from the str library
...
def get_number(string):
    ...
    # Functions return None by default, so no return statement is necessary
    # (nor is an else block required after the if statement).
    # I.e. when 'if digits' does not evaluate to true, then the function will
    # return None.
    # 
    # This means that the following are redundant here:
    # return
    # return None
