class Student(object):
    ...
    def get_enrolments(self):
        ...
        Student.get_enrolments() -> list( (str, int) )
        """
...
class CollegeStudent(Student):
    ...
    def get_college(self):
        ...
        CollegeStudent.get_college() -> str
        """
    ...
    def calculate_fees(self):
        ...
        CollegeStudent.calculate_fees() -> int
        """
...
class LinkParser1(HTMLParser):
    """ Class for obtaining links from html
    """
    def __init__(self):
        """
        Creates an instance LinkParser1 to parse hyperlinks from html text.

        Constructor: LinkParser1()
        """
    ...
    def handle_starttag(self, tag, attrs):
        ...
        LinkParser1.handle_starttag(str, list<tuple<str, str>>)
...
class LinkParser2(HTMLParser):
    ...
    def __init__(self):
        """
        Creates an instance LinkParser2 to parse hyperlinks from html text.

        Constructor: LinkParser2()
        """
    ...
    def handle_starttag(self, tag, attrs):
        ...
        LinkParser2.handle_starttag(str, list<tuple<str, str>>)
...
class LinkParser(HTMLParser):
    ...
    def handle_starttag(self, tag, attrs):
        ...
        LinkParser.handle_starttag(str, list<tuple<str, str>>)
        """
